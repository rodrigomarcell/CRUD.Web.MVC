using CRUD.Web.MVC.Models.Contexto;
...
namespace CRUD.Web.MVC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        {
            List<Usuario> lista = _contexto.Usuario.ToList();
            CarregaTipoUsuario();
            return View(lista);
        }
        ...
        {
            List<SelectListItem> ItensTipoUsuario = new List<SelectListItem>
            {
            ...
            ViewBag.TiposUsuarios = ItensTipoUsuario;
        }
